...
let disponibilidad= true; // Boolean
...
document.write("Nombre: " + nombre + "<br>" , "canidad: " + cantidad + "<br>", "Precio: " + precio + "<br>", "Disponibilidad: " + disponibilidad + "<br>", "Descipcion: " + descripcion);

console.log("Nombre: ", nombre, "canidad: ", cantidad, "Precio: ", precio, "Disponibilidad: ", disponibilidad, "Descipcion: ", descripcion);